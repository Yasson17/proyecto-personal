    ...
    foreach($result as $filas)
      {
        echo "<tr class='text-center roboto-medium'>";
          ...
          echo "<td style='background:white;'>  <a href='consultaADMI.php?Cedula=".$filas['ci']."'> <button type='btn btn-success' class='btn btn-success'> <i class='fa fa-eye' style='color:blue'></i> </a> </td>";

          echo "<td style='background:white;'> <a href='Eliminar.php?Cedula=".$filas['ci']."'><button type='btn btn-success' class='btn btn-danger'><i class='fa fa-trash' style='color:red'></i></button></a> </td>";
...
<div id="modal1" class="modal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background:#5D6D7E;color:white" >
        <h5 class="modal-title"><legend><i class="fas fa-user"></i> &nbsp; Buscar Usuario</legend></h5>
...
<fieldset>
      ...
      <div class="modal-footer">
        ...
        <button class="btn btn-success" type="submit" value="Buscar" name="Buscar" style="background:red;color:white"><i class="fas fa-search"></i> &nbsp;
                     	Buscar
                     </button>
      </div>
      </form>
