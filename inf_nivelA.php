...
else
{
 ...
 echo"<li>
          ...
          <li>
           ...
           <li>
              <a href="inf_nivelA.php" style="background:red;color:white; "><i  class="fa fa-list fa-fw"></i> &nbsp; Nivel Academico</a>
            </li>
...
<center>
  <form action="Intro_Ni.php" method="post">
    ...
    <tr class="text-center roboto-medium" style="background:#5D6D7E;">  
      <th> Especialización </th>
        ...
        <th> Instituto/Universidad </th>
          ...
          <th> <input type="VARCHAR" name="Especializacion" class="form-control" required> </th>
        <th> <input type="VARCHAR" name="Titulo_O" class="form-control" required> </th>
        <th> <input type="date" name="Ano_G" class="form-control" required> </th>
        <th> <input type="VARCHAR" name="Inst_Univ" class="form-control" required> </th>
...
<tr style='background:white;' class='text-center roboto-medium'>
    <th>  <input type="VARCHAR" name="Observaciones" class="form-control"> </th>
    <th></th>
    <th></th>
    <th></th>
    </tr>
