...
echo "</center>";
echo"<br>";
 echo "<form action='link_admi/Act_P.php' method='post' enctype='multipart/form-data'>";
...
echo "<div class='table-responsive'>";
 ...
 echo"<tr style='background:white;' class='text-center roboto-medium'>
    <th> <input type='text' id='Nombres' name='Nombres' value='".$fila['Nombres']."' readonly> </th>
 ...
 echo"<tr style='background:white;' class='text-center roboto-medium'>
    <th> <input type='int' id='edadh' name='Edadp' value= ".$fila['Edad'] ." readonly> </th>
        <th> <input type='text' readonly id='Sexo' name='Se' value=".$fila['Sexo']." > </th>
...
<option value='soltero'>Soltero(a)</option>
        ...
        <th> <input type='text' readonly id='Derecho' name='Derecho' value=". $fila['Derecho']." > </th>
...
echo"<tr style='background:white;' class='text-center roboto-medium'>
    <th> <input type='text' id='Zurdo' name='Zurdo' value= ".$fila['Zurdo'] ." readonly> </th>
...
echo"<tr style='background:white;' class='text-center roboto-medium'>
    <th> <input type='VARCHAR' id='Nombre_Conyuge' name='Nombre_Conyuge' value= '".$fila['Nombre_Conyuge'] ."'> </th>
       ...
       <script src='autojs_admi/Redireccion_agghijos.js'></script>

<th>   <select id='Si_Embarazo' name='Si_Embarazo' value=".$fila['Si_Embarazo'].">
...
echo "</center>";
echo"<br>";
      echo " <form action='link_admi/Act_H.php' method='post'>";
...
echo"</thead>";
       ...
       echo"<tr style='background:white;' class='text-center roboto-medium'>
      <th><input type='text' name='Sexo[".$actualiH['IDH']."]' value='".$actualiH['Sexo']."' readonly></th>";
...
echo "</center>";
    ...
    if ($totalF>0) 
    {
         echo " <form action='link_admi/Act_Nu.php'method='post'>";
...
echo "<table>";
 echo "<tr><th><button type='submit' class='btn btn-success' style='background:#ffe65d;color:#0a0a0a;'><strong>Guardar Cambios</strong></button></th></tr>";
echo "</table>";
echo"</form>";
...
echo "</center>
    ...
    if ($totalF>0) 
    {
echo"<form action='link_admi/Act_Ni.php' method='post'>";
...
echo"<tr style='background:white;' class='text-center roboto-medium'> 
  <th> <input type='VARCHAR' readonly name='Observaciones[".$actualiA['IDA']."]' value='".$actualiA['Observaciones']."'> </th>
...
echo "</center>
    ...
    if ($totalF>0) 
    {
 echo " <form action='link_admi/Act_F.php' method='post'>";
...
echo "</center>
    ...
    if ($totalF>0) 
    {
 echo " <form action='link_admi/Act_Exp.php' method='post'> 
      <br>";
...
echo"<tr style='background:white;' class='text-center roboto-medium'> 
      ...
      <th> <input type='VARCHAR' name='Antecedentes_S[".$actualiE['IDE']."]' value='".$actualiE['Antecedentes_S']."' readonly> </th>
...
echo "</center>
      <br>";
 echo " <form action='link_admi/Act_I.php' method='post'> ";
...
echo"<tr style='background:white;' class='text-center roboto-medium'> 
  <th> <input type='date' name='Fecha_ABAE[".$actualiI['IDI']."]' value='".$actualiI['FechaI_ABAE']."' readonly> </th>
    <th> <input type='VARCHAR' name='CargoI[".$actualiI['IDI']."]' value='".$actualiI['Cargo']."' readonly> </th>
     <th>  <input type='VARCHAR' name='Sede[".$actualiI['IDI']."]' value='".$actualiI['Sede']."' readonly> </th>
     <th> <input type='VARCHAR' name='Direccion_A[".$actualiI['IDI']."]' value='".$actualiI['Direccion_A']."' readonly> </th>
    </tr>";
...
echo"<tr style='background:white;' class='text-center roboto-medium'>   
      <th> <input type='VARCHAR' name='Unidad_A[".$actualiI['IDI']."]' value='".$actualiI['Unidad_A']."' readonly> </th>
         <th> <input type='VARCHAR' name='Jefe_I[".$actualiI['IDI']."]' value='".$actualiI['Jefe_I']."' readonly> </th>
          <th> <input type='date' name='Fecha_Servicio[".$actualiI['IDI']."]' value='".$actualiI['FechaI_Servicio']."' readonly> </th>
           <th> <input type='number' name='TotalA_Serv[".$actualiI['IDI']."]' value='".$actualiI['TotalA_Serv']."' readonly> </th>
    </tr>";
...
echo"<tr style='background:white;' class='text-center roboto-medium'>   
        ...
        <th> <input type='VARCHAR' name='CorreoE_Ins[".$actualiI['IDI']."]' value='".$actualiI['CorreoE_Ins']."' readonly> </th>
         <th> <input type='VARCHAR' name='Telefono_O_Ext[".$actualiI['IDI']."]' value='".$actualiI['Telefono_O_Ext']."' readonly> </th>
          <th> <input type='VARCHAR' name='Familiares_ABAE[".$actualiI['IDI']."]' value='".$actualiI['Familiares_ABAE']."' readonly> </th>
           <th> <input type='VARCHAR' name='NombresI[".$actualiI['IDI']."]' value='".$actualiI['Nombres']."' readonly> </th>
    </tr>";


     echo"<tr><th><input type='hidden' name='CedulaID[".$actualiI['IDI']."]' value='".$actualiI['CedulaID']."' ></th>
<th><input type='hidden' name='Ce' value='".$C."' ></th>
<th></th>
<th></th>
     </tr>";
...
echo "</center>
    ...
    if($totalF>0)
    {
 echo " <form action='link_admi/Act_C.php' method='post'> ";
...
echo"<tr style='background:white;' class='text-center roboto-medium'>   
  ...
  <th> <input type='date' name='FechaI_ServicioC[".$actualiC['IDM']."]' value='".$actualiC['FechaI_Servicio']."' readonly> </th>
    <th> <input type='number' name='Ano_S[".$actualiC['IDM']."]' value='".$actualiC['Ano_S']."' readonly> </th>
     <th>  <input type='VARCHAR' name='Institu_P[".$actualiC['IDM']."]' value='".$actualiC['Institu_P']."' readonly> </th>
     <th> <input type='VARCHAR' name='Rango_M[".$actualiC['IDM']."]' value='".$actualiC['Rango_M']."' readonly> </th>
    </tr>";


                   echo "<thead>";
                            echo "<tr class='text-center roboto-medium' style='background:#5D6D7E;'>
                                <th>Tiempo de Comision de Servicio</th>
                                <th> Fecha de Inicio de Comision de Servicio</th>
...
echo "</center>
      <br>";
 echo " <form action='link_admi/Act_Otros.php' method='post'>";
...
echo"<tr style='background:white;' class='text-center roboto-medium'>   
    ...
    <th> <input type='text' name='Carnet_P[".$actualiO['IDO']."]' value='".$actualiO['Carnet_P']."' readonly> </th>
        <th> <input type='number' name='Codigo_C[".$actualiO['IDO']."]' value='".$actualiO['Codigo_C']."' readonly> </th>
        <th> <input type='number' name='Serial_C[".$actualiO['IDO']."]' value='".$actualiO['Serial_C']."' readonly> </th>
...
echo"<tr style='background:white;' class='text-center roboto-medium'>   
    ...
    <th> <input type='text' name='Carnet_PSUV[".$actualiO['IDO']."]' value='".$actualiO['Carnet_PSUV']."' readonly> </th>
        <th> <input type='number' name='Codigo_P[".$actualiO['IDO']."]' value='".$actualiO['Codigo_P']."' readonly> </th>
        <th> <input type='number' name='Serial_P[".$actualiO['IDO']."]' value='".$actualiO['Serial_P']."' readonly> </th>
...
<div class="modal " id="Agregar" tabindex="-1" role="dialog" >
      ...
      <div class="modal-dialog modal-lg">
        ...
        <div class="modal-header" style="background:#000077; color: white;">
          ...
          <form method="post" action="link_admi/agg_mod_familiar_Ind.php">
...
<div class="modal" id="NivelA" tabindex="-1" role="dialog" >
      ...
      <div class="modal-dialog modal-lg">
        ...
        <div class="modal-header" style="background:#000077; color: white;">
          ...
          <form method="post" action="link_admi/agg_mod_nivel.php">
...
<div class="modal" id="formacion" tabindex="-1" role="dialog" >
      ...
      <div class="modal-dialog modal-lg">
        ...
        <div class="modal-header" style="background:#000077; color: white;">
          ...
          <form method="post" action="link_admi/agg_mod_formacion.php">
...
<div class="modal" id="expe" tabindex="-1" role="dialog" >
      ...
      <div class="modal-dialog modal-lg">
        ...
        <div class="modal-header" style="background:#000077; color: white;">
          ...
          <form method="post" action="link_admi/agg_mod_experiencia.php">
...
<div class="modal" id="comision" tabindex="-1" role="dialog" >
      ...
      <div class="modal-dialog modal-lg">
        ...
        <div class="modal-header" style="background:#000077; color: white;">
          ...
          <form method="post" action="link_admi/agg_mod_comision.php">
...
<script src="autojs_admi/calcuEdadH.js" ></script>
