...
<div class="header" style="text-align:right;">
  ...
  <div class="header_logo">
     <div align="right">
       ...
       <h2 style="color:black;" >Solicitud de Reposo ABAE<img src="../assets/avatar/logo.jpeg" class="img-fluid" alt="Avatar"></h2>
...
<table> 
<tr>
  <br><button type='submit' class='btn btn-succes' value='Ver Solicitud' name='Gene' style='background:#ffe65d;color:#0a0a0a;' ><strong>Ver Solicitud</strong></button>&nbsp; &nbsp;
