 ...
 <div class="col-12 col-md-6">
  <div class="form-group">
   ...
   <thead>
    ...
    <th> <input type="hidden" name="sin" value="<?php echo $consulta[0]?>" readonly> </th>
    <th> <input type="hidden" name="super" value="super" readonly> </th>
    <th> <input type="hidden" name="s" value="s" readonly> </th>
...
if(($status=='Enviado') && ($CedulaID==$consulta[0]))
{
 echo"
