  ...
  <div class="form-group">
   ...
   <thead>
     <tr class="text-center roboto-medium" style="background:#5D6D7E;"> 
        ...
        <input type="hidden" name="Tipo" value="NOTIFICACION GENERAL" readonly="">
...
{
  echo "<textarea style='resize: none; border-color: black;' name='Descripcion' rows='5' cols='50' placeholder='Por favor describa detalladamente su solicitud.' required></textarea>
      </table>";
}
?>
      </table>
...
if(isset($estado)=='General')
{  
  echo "<h5><strong>Notificación Enviada a Todo el Personal.</strong></h5>";
}
else
{
  echo"
  <button type='submit' class='btn btn-succes' value='Enviar Solicitud' name='gene' style='background:#ffe65d;color:#0a0a0a;'><strong>Enviar Notificación</strong></button>";
