...
$TelefonoH=$num1.$TelefonoH;

$num2=$_POST['num2'];
$TelefonoM=$_POST['TelefonoM'];

$TelefonoM=$num2.$TelefonoM;
...
$repetido="SELECT * FROM inventario.datos_p WHERE Correo_Elect='".$Correo."' ";
$fuera=$conex->query($repetido);

$totalrepe=mysqli_num_rows($fuera);

if($totalrepe>0)
{
    echo"<script type='text/javascript'>
    alert('Su Correo Electronico ya se Encuentra Registrado, Por Favor Verifique sus Datos');
