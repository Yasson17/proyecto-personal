<?php
	...
	include '../Conexion.php';
        ...
        echo "<script type='text/javascript'>
            ...
            window.location.href = '../Modificar_U.php?Cedula='+ $Cedula +'';
            </script>";
        }
	}
