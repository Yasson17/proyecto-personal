...
$sql="SELECT * FROM administrador2.admi WHERE `ci`= '".$Cedula."'";
...
$ascenso="INSERT INTO Administrador2.usuarios (`usuarios`,`contrasena`,`nombre`,`ci`,`status`) VALUES ('$usuarios','$contrasena','$nombre','$ci','$status')";
$resul=mysqli_query($conex,$ascenso);

$Del="DELETE FROM administrador2.admi WHERE `ci`= '".$Cedula."'";
