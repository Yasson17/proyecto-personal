           ...
           <li>
            ...
            <li>
              <a href="inf_lab.php" style="color:white; "><i  class="fa fa-list fa-fw"></i> &nbsp; Datos Institucion</a>
               ...
               <li>
             <a href="inf_comision.php" style="background:red;color:white; "><i  class="fa fa-list fa-fw"></i> &nbsp;  Comision de Servicio (C/M)</a>
            </li>
...
<center>
  <form action="Intro_M.php" method="post">
...
<center>
    <h2>En Caso de ser Personal de Comision <br> (Civil o Militar)</h2>
  </center>
  ...
  <div class="form-group">
     ...
     <tr style='background:white;' class='text-center roboto-medium'>   
        <th> <input type="date" id="Fecha_N" name="FechaI_Servicio" class="form-control"> </th>
        <th> <input type="number" id="edadh" name="Ano_S" class="form-control"> </th>
        <th> <input type="varchar" name="Institu_P" class="form-control"> </th>
        <th>  <input type="varchar" name="Rango_M" class="form-control"> </th>
...
<tr class="text-center roboto-medium" style="background:#5D6D7E;"> 
    ...
    <tr style='background:white;' class='text-center roboto-medium'>   
        <th> <input type="varchar" name="TiempoC_S" class="form-control"> </th>
        <th> <input type="date" name="FechaI_Ser" class="form-control"> </th>
        <th> <input type="date" name="FechaC_Ser" class="form-control"> </th>
        <th></th>
    </tr>
