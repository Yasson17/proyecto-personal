...
<script>
  ...
  function maxLengthCheck(object)
  {
	...
	<div class="registro">
<span> No posees un usuario?</span><a  href="#" style="font-size:16px;  text-decoration:none; color:#fff ;border:none;" data-toggle="modal" data-target="#registroUSU">
	 <span class="efecto">Registrarte</span>
</a>
	</div>

	<div class="contenedor">
<button  style="background:#120050; color:#fff ; border:none; font-size:14px;" data-toggle="modal" data-target="#registrocontra">
	...
	<div class="modal-dialog" role="document">
	    <div class="modal-content">
	    	<div class="modal-header" style="background:#000077; color: white;">
	    		<legend><i class="fas fa-user"></i> &nbsp; Registro de Usuario </legend>
