...
$GLOBALS['C_U'] = $C_U;
    ...
    if(isset($C_U))
      {
        echo "<li> <a style='background:red;color:white;' href='Notificaciones/Index_reportesV.php?Cedula=$consulta[1]'><i class='fas fa-file fa-fw'></i> &nbsp;Notificaciones  </a>";
      }
      else
      {
      ...
      <nav class="full-box navbar-info" >
        <a href="#" class="float-left show-nav-lateral">
          <i class="fas fa-exchange-alt" ></i>
             ...
             echo "<a href='Modificar_U.php?Cedula=$consulta[1]'><i class='fa fa-sync-alt'></i>  Actualizacion De Datos </a>";
?>
...
?>
                ...
                <center>
  <a href="usuario.php"><button type="button" class='btn btn-succes' style="background:#ffe65d;color:#0a0a0a;" ><strong>Aceptar</strong></button></a>
