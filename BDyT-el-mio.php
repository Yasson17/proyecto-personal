...
$resul = $conex->query('CREATE TABLE `inventario`.`documentos` (`IDdoc` int(100) NOT NULL AUTO_INCREMENT,  `archivo` longblob NOT NULL, `observaciones` VARCHAR(1000) NOT NULL,`departamento` VARCHAR(100) NOT NULL,`fecha` date NOT NULL, `CedulaID` int(20) NOT NULL, `status` text(20) NOT NULL, PRIMARY KEY (`IDdoc`)) ENGINE = InnoDB');
