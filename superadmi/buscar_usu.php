...
$cons ="SELECT * FROM Administrador2.usuarios WHERE  nombre LIKE '%$datos%' OR ci LIKE '%$datos%'";
...
echo"</center>";
                    ...
                    <center>
  <a href="lista_usuario.php"><button type="button" class='btn btn-succes' style="background:#ffe65d;color:#0a0a0a;" ><strong>Aceptar</strong></button></a>
</center>
