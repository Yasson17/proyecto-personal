...
$resul = $conex->query("SELECT * FROM inventario.Datos_P WHERE `Cedula` LIKE '$Cedula' ORDER BY `Cedula` DESC");
             ...
             echo "<a href='ModificarSUP.php?Cedula=".$Cedula."'> <i class='fa fa-sync-alt'></i>&nbsp;Actualizacion de Datos  </a>";
...
$resul = $conex->query("SELECT * FROM inventario.Datos_P WHERE Cedula='".$Cedula."' ");
