  ...
  <div class="header_logo">
     <div align="right">
      ...
      <nav class="full-box navbar-info">
        ...
        <a id="btn1" >Buscar Administrador
		...
		<!-- contenido de la pagina -->	
			...
			<h2 class="text-center">
					<i class="fab fa-dashcube fa-fw"></i>&nbsp;Lista De Administradores
				</h2>
				<br>
<div class="container-fluid">
				<div class="table-responsive">
					<table class="table table-dark table-sm">
						...
						<!-- proceso para mostrar la tabla de administradores -->
<?php
$status='Activo';
$sql="SELECT * FROM administrador2.admi WHERE `status`='".$status."'";
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background:#CA1818;color:white" >
        <h5 class="modal-title"><legend style="color: black"><i class="fas fa-user"></i> &nbsp; Buscar Administrador</legend></h5>
        
      </div>

      <form method="post" action="buscar_admi.php">
      <div class="modal-body">
