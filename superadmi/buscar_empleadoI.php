...
$cons ="SELECT * FROM inventario.datos_p WHERE  Nombres LIKE '%$datos%' OR Cedula LIKE '%$datos%' ";
...
echo "<td style='background:white;'> <a href='consultaSUP.php?Cedula=".$filas['Cedula']."'> <button type='btn btn-success' style='border-color:white;background:white'> <i class='fa fa-eye' style='color:blue'></i> </button></a> </td>";
...
echo"</center>";
                    ...
                    <center>
  <a href="Index_Inhactivos.php"><button type="button" class='btn btn-succes' style="background:#ffe65d;color:#0a0a0a;" ><strong>Aceptar</strong></button></a>
</center>
