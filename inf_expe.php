...
else
{
 ...
 echo"<li>
          ...
          <li>
           ...
           <li>
              <a href="inf_expe.php" style="background:red;color:white; "><i  class="fa fa-list fa-fw"></i> &nbsp; Experiencia Administracion P</a>
            </li>
...
<br>
<center>
  <form action="Intro_E.php" method="post">
...
<center>
    <h2>Experiencia Laboral en la Administracion Pública</h2>
  </center>
  ...
  <div class="form-group">
     ...
     <tr style='background:white;' class='text-center roboto-medium'>  
        <th> <input type="VARCHAR" name="Organismo" class="form-control"> </th>
        <th> <input type="date" name="Fecha_I" class="form-control"> </th>
        <th> <input type="date" name="Fecha_E" class="form-control"> </th>
        <th>  <input type="VARCHAR" name="Cargo" class="form-control"> </th>
    </tr>
 <thead>
       <tr class="text-center roboto-medium" style="background:#5D6D7E;"> 
     ...
     <tr style='background:white;' class='text-center roboto-medium'>   
        <th> 
            <select name="Antecedentes_S" class="form-control">
