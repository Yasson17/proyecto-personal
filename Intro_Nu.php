...
$insert = "INSERT INTO inventario.Nucleo_F (`Parentesco`, `Nombres`, `Apellidos`, `Cedula`, `Fecha_N`, `Edad`, `Sexo`, `Estado_C`, `Grado_I`, `CedulaID`) VALUES ('$Parentesco', '$Nombres', '$Apellidos', '$Cedula', '$Fecha_N','$Edad','$Sexo','$Estado_C','$Grado_I', '$CedulaID')"; 
